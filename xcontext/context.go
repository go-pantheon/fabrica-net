...
const (
	...
	CtxColor       = "x-md-global-color"        // Color of this connection
	CtxStatus      = "x-md-global-status"       // Status of this connection
	CtxReferer     = "x-md-global-referer"      // example: gate:10.0.1.31 or player:10.0.2.31
	CtxClientIP    = "x-md-global-client-ip"    // Client remote IP
...
func OID(ctx context.Context) (int64, error) {
	...
	id, err := strconv.ParseInt(v, 10, 64)
	if err != nil {
		return 0, errors.Wrapf(err, "oid must be int64, but got %s", v)
	}
...
func SID(ctx context.Context) (int64, error) {
	...
	id, err := strconv.ParseInt(v, 10, 64)
	if err != nil {
		return 0, errors.Wrapf(err, "sid must be int64, but got %s", v)
	}
...
func Status(ctx context.Context) int64 {
	if md, ok := metadata.FromServerContext(ctx); ok {
		...
		if err != nil {
			log.Errorf("status must be int64, but got %s", v)
			return 0
		}
